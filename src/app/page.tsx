...
export const metadata: Metadata = {
  title: "Soluciones web y m贸viles a tu medida",
  description: "Desarrollo de sitios web, apps m贸viles e integraciones a la medida. Rendimiento, SEO y seguridad para tu negocio.",
  alternates: { canonical: "/" },
  openGraph: {
    title: "Soluciones web y m贸viles a tu medida",
    description: "Sitios r谩pidos, seguros y escalables con tecnolog铆as modernas.",
    url: "/",
  },
};
      ...
      <section className="max-w-6xl mx-auto px-4 pt-16 pb-20 grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
            Soluciones web y m贸viles a tu medida
          </h1>
          <p className="mt-4 text-neutral-600">
            Desarrollamos productos r谩pidos, seguros y escalables para tu negocio.
          </p>
        ...
        {[
          {
            ...
            alt: "Apps m贸viles",
            desc:
              "Dise帽o y desarrollo de apps m贸viles nativas o multiplataforma, listas para escalar. Arquitectura escalable, alto rendimiento, calidad de c贸digo y QA automatizado. Integraciones seguras, para llevar tu idea a producci贸n.",
          },
          {
            title: "Sitios web",
            src: "/sitiosweb.jpg",
            alt: "Sitios web",
            desc: "Landing pages, sitios web r醦idos, E-commerce y Corporativos, accesibles y listos para convertir. Dise駉 responsivo, rendimiento de primera y arquitectura moderna lista para crecer.",
          },
          {
            title: "Integraciones & APIs",
            src: "/integracionesapi.jpg",
            alt: "Integraciones y APIs",
            desc: "Conectamos tu producto con pagos, CRM y terceros. Integraciones seguras y escalables para tu operaci贸n.",
          },
        ].map((card) => (
