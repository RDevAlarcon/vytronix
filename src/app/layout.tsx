    ...
    <html lang="es">
      <body className="min-h-screen">
          ...
          <div className="max-w-6xl mx-auto px-4 py-6 text-sm grid gap-6 md:grid-cols-3 md:divide-x md:divide-neutral-400">
            ...
            <div className="flex items-center justify-center md:justify-end md:pl-6">
              <div className="flex items-center gap-4 text-neutral-700">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full border-2 border-neutral-500 text-black transition-transform duration-200 hover:scale-105 hover:border-neutral-600 hover:bg-white/60 focus-visible:ring-2 focus-visible:ring-neutral-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white" aria-label="TikTok" tabIndex={0}>
                ...
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full border-2 border-neutral-500 text-[#E1306C] transition-transform duration-200 hover:scale-105 hover:border-neutral-600 hover:bg-white/60 focus-visible:ring-2 focus-visible:ring-neutral-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white" aria-label="Instagram" tabIndex={0}>
                  <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-hidden="true">
                ...
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full border-2 border-neutral-500 text-[#1877F2] transition-transform duration-200 hover:scale-105 hover:border-neutral-600 hover:bg-white/60 focus-visible:ring-2 focus-visible:ring-neutral-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white" aria-label="Facebook" tabIndex={0}>
                  <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-hidden="true">
                    <path d="M13.5 9H16V6h-2.5C10.8 6 10 7.8 10 9.6V12H8v3h2v6h3v-6h2.4l.6-3H13V9.9c0-.6.3-.9.9-.9Z"/>
                  </svg>
                </span>
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full border-2 border-neutral-500 text-[#0A66C2] transition-transform duration-200 hover:scale-105 hover:border-neutral-600 hover:bg-white/60 focus-visible:ring-2 focus-visible:ring-neutral-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white" aria-label="LinkedIn" tabIndex={0}>
                  <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-hidden="true">
        ...
        <a
          ...
          className="wa-fixed inline-flex items-center justify-center w-12 h-12 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white shadow-lg"
        >
